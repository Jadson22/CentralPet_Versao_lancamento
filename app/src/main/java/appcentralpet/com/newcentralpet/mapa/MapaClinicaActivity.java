...
public class MapaClinicaActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Clínicas e PetShops");
        ...
        if(!locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER) && !locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER)) {
            Toast.makeText(this, "Ative sua localização (GPS)", Toast.LENGTH_LONG).show();
        }
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyDEM_ko9vfmSwudvp6LTkDp3flGuYemAy8");
