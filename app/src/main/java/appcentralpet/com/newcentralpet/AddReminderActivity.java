...
import appcentralpet.com.newcentralpet.reminder.AlarmScheduler;
...
public class AddReminderActivity extends AppCompatActivity implements
        ...
        com.wdullaer.materialdatetimepicker.date.DatePickerDialog.OnDateSetListener, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRepeatText.setText("A cada" + mRepeatNo + " " + mRepeatType);
        ...
        getSupportActionBar().setTitle("Detalhes do alarme");
    ...
    private void showDeleteConfirmationDialog() {
        ...
        // for the postivie and negative buttons on the dialog.
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage("Deletar o lembrete?");
    ...
    private void deleteReminder() {
        ...
        if (mCurrentReminderUri != null) {
            ...
            if (rowsDeleted == 0) {
                ...
                Toast.makeText(this,("Lembrete deletado"),
                        Toast.LENGTH_SHORT).show();
            }
        }
...
*/
        ...
        if (mCurrentReminderUri == null) {
            ...
            if (newUri == null) {
                ...
                Toast.makeText(this,("Erro ao salvar lembrete"),
                        Toast.LENGTH_SHORT).show();
            } else {
            ...
            if (rowsAffected == 0) {
                ...
                Toast.makeText(this,("Erro na atualização do lembrete"),
                        Toast.LENGTH_SHORT).show();
            } else {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            mRepeatText.setText("A cada " + repeatNo + " " + repeatType);
            // Setup up active buttons
            // Setup repeat switch
            if (repeat == null){
